...
(ÖRNEK (nesne-alttan-sek (nesne test-circle (v 3 4) (v 1 -2) (v 4 0)) test-square)
       test-square)

(ÖRNEK (nesne-alttan-sek (nesne test-circle (v 3 4) (v 1 -2) (v 4 0)) test-square)
       (nesne test-circle (v 3 -4) (v 1 -2) (v 4 0)))
...
; ilk evren 
(define yaradılış
  (evren (nesne test-circle (v 30 40) (v 2 -7) (v 0 1)) (nesne test-circle2 (v 60 70) (v 3 -8) (v 0 1)) (bitmap "garden.png")))
