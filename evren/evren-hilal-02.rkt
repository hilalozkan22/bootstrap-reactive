...
; şeffaflık  : resim
; renk : resim
(STRUCT imaj (şekil boy en şeffaflık renk))

;image-height
;imaj -> sayı
;nesnenin imajını alır ve imajın boyunu verir.
;template
;(define (image-height im)
; ... (imaj-boy im ) ... )

(define deneme
  (rectangle 100 200 "solid" "purple"))
(define (image-height im)
  (imaj-boy im))
...
; ilk evren 
(define yaradılış
  (evren (nesne test-circle (v 30 40) (v 2 -7) (v 0 1)) (nesne test-circle2 (v 60 70) (v 3 -8) (v 0 1)) test-square2))
